...
public class ViewCrearCredencialB extends JFrame {
	...
	public ViewCrearCredencialB() throws UnsupportedLookAndFeelException {
...
//		jlbImg1 = new javax.swing.JLabel();
		...
		jlbNomTarjeta = new javax.swing.JLabel();
...
//		jlbImg1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/img5.png")));
		jlbIcoP.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/ico2.png")));

		jlbTitulo2.setBackground(new java.awt.Color(51, 51, 51));
		jlbTitulo2.setFont(new java.awt.Font("Roboto Flex", 1, 16)); // NOI18N
		jlbTitulo2.setText("BANCO");

		jlbCVV.setFont(new java.awt.Font("Roboto", 0, 16)); // NOI18N
		jlbCVV.setText("CVV :");

		jlbBanco.setFont(new java.awt.Font("Roboto", 0, 16)); // NOI18N
		jlbBanco.setText("Nombre del Banco :");

		jlbNomTarjeta.setFont(new java.awt.Font("Roboto", 0, 16)); // NOI18N
		jlbNomTarjeta.setText("Numero de Tarjeta :");

		jlbCaducidad.setFont(new java.awt.Font("Roboto", 0, 16)); // NOI18N
		...
		//JTextField
		txtNomTarjeta.setFont(new java.awt.Font("Roboto", 0, 15));

		txtCVV.setFont(new java.awt.Font("Roboto", 0, 15)); // NOI18N

		txtBanco.setFont(new java.awt.Font("Roboto", 0, 15)); // NOI18N

		txtCaducidad.setFont(new java.awt.Font("Roboto", 0, 15)); // NOI18N
...
//		PanelPrincipal.add(jlbImg1, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 0, -1, -1));
		int factor = 250;
		PanelPrincipal.add(jlbIcoP, new org.netbeans.lib.awtextra.AbsoluteConstraints(600 - factor, 50, -1, -1));
		PanelPrincipal.add(jlbTitulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(600 - factor, 140, -1, -1));
		PanelPrincipal.add(jlbCVV, new org.netbeans.lib.awtextra.AbsoluteConstraints(320 - factor, 360, -1, -1));
		PanelPrincipal.add(txtNomTarjeta, new org.netbeans.lib.awtextra.AbsoluteConstraints(320 - factor, 310, 410, 30));
		PanelPrincipal.add(jlbBanco, new org.netbeans.lib.awtextra.AbsoluteConstraints(320 - factor, 200, -1, -1));
		PanelPrincipal.add(txtCVV, new org.netbeans.lib.awtextra.AbsoluteConstraints(320 - factor, 390, 180, 30));
		PanelPrincipal.add(jlbNomTarjeta, new org.netbeans.lib.awtextra.AbsoluteConstraints(320 - factor, 280, -1, -1));
		PanelPrincipal.add(txtBanco, new org.netbeans.lib.awtextra.AbsoluteConstraints(320 - factor, 230, 240, 30));
		PanelPrincipal.add(jlbCaducidad, new org.netbeans.lib.awtextra.AbsoluteConstraints(320 - factor, 440, -1, -1));
		PanelPrincipal.add(txtCaducidad, new org.netbeans.lib.awtextra.AbsoluteConstraints(320 - factor, 470, 180, 30));
		PanelPrincipal.add(jlbDatos, new org.netbeans.lib.awtextra.AbsoluteConstraints(320 - factor, 520, -1, -1));
		PanelPrincipal.add(txtDatos, new org.netbeans.lib.awtextra.AbsoluteConstraints(320 - factor, 550, 410, 30));
		PanelPrincipal.add(bGuardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(810 - factor, 460, 150, 50));
		PanelPrincipal.add(bRegresar, new org.netbeans.lib.awtextra.AbsoluteConstraints(810 - factor, 530, 150, 50));
