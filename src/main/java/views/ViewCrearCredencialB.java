...
public class ViewCrearCredencialB extends JFrame{
    ...
    public ViewCrearCredencialB(){
        ...
        PanelPrincipal.add(jlbTitulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 140, -1, -1));
        PanelPrincipal.add(jlbCVV, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 360, -1, -1));
        PanelPrincipal.add(txtNomTarjeta, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 310, 410, 30));
        PanelPrincipal.add(jlbBanco, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 200, -1, -1));
        PanelPrincipal.add(txtCVV, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 390, 180, 30));
        PanelPrincipal.add(jlbNomTarjeta, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 280, -1, -1));
        PanelPrincipal.add(txtBanco, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 230, 240, 30));
        PanelPrincipal.add(jlbCaducidad, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 440, -1, -1));
        PanelPrincipal.add(txtCaducidad, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 470, 180, 30));
