...
public class ViewCrearCredencialP extends JFrame {
	...
	public ViewCrearCredencialP() throws UnsupportedLookAndFeelException {
...
//		PanelPrincipal.add(jlbImg1, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 0, -1, -1));
		...
		PanelPrincipal.add(jlbTitulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(590 - factor, 140, -1, -1));
		PanelPrincipal.add(jlbPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(320 - factor, 360, -1, -1));
		PanelPrincipal.add(txtUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(320 - factor, 310, 410, 30));
		PanelPrincipal.add(jlbPlataforma, new org.netbeans.lib.awtextra.AbsoluteConstraints(320 - factor, 200, -1, -1));
		PanelPrincipal.add(txtPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(320 - factor, 390, 240, 30));
		PanelPrincipal.add(jlbUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(320 - factor, 280, -1, -1));
		PanelPrincipal.add(txtPlataforma, new org.netbeans.lib.awtextra.AbsoluteConstraints(320 - factor, 230, 240, 30));
		PanelPrincipal.add(jlbURL, new org.netbeans.lib.awtextra.AbsoluteConstraints(320 - factor, 440, -1, -1));
		PanelPrincipal.add(txtURL, new org.netbeans.lib.awtextra.AbsoluteConstraints(320 - factor, 470, 410, 30));
