...
public class ViewCredencialB extends JFrame{
    ...
    public ViewCredencialB(){
        ...
        jlbIco1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/eyeOff1.png")));
        
        jlbIco2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/eyeOff1.png")));
